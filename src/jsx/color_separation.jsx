  ...
  for (var ub = 0; ub < enabledUnderbaseIndices.length; ub++) {
   ...
   if (ubIndex === 0) {
    ...
    if (!ub2PlusSwatchName) {
     ub2PlusSwatchName = getDefaultUnderbaseWhiteSwatchName(app.activeDocument);
     appendLeapSepLog("UB2+ default swatch: " + ub2PlusSwatchName);
    }
    ubSwatchName = ub2PlusSwatchName;
   }
